...
xml.chart(:caption=> caption, :formatNumberScale=>'1', :xAxis => 'Date', :yAxis => 'Issues', :yAxisMinValue => '0', :yAxisMaxValue => '100', :syncAxisLimits => '1', :numberSuffix=>'%', :showValues => '0', :anchorAlpha => '0', :labelStep => labelStep, :labelDisplay => 'Rotate', :slantLabels=>'1') do
  xml.categories do
