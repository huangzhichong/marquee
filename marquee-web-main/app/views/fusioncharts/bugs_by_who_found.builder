...
xml.chart(:caption=>caption, :formatNumberScale=>'0', :xAxis => 'Requirements', :yAxis => 'Issues', :yAxisMinValue => '0', :showValues => '0', :anchorAlpha => '0', :lineThickness => '5', :labelStep => labelStep, :labelDisplay => 'Rotate', :slantLabels=>'1') do
  xml.categories do
